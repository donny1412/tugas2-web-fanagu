          ...
          <div class="col-lg-9">
          	<div class="row">
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/RidwanMulyaqin.jpg);">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">  
				    						<h3><a href="#">Ridwan Mulyaqin</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
			    						...
			    						<div class="two">
			    							<span class="price per-price">Rp 250.000<br><small>/Day</small></span>
		    							</div>
		    						</div>
		    			...
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/YuliantiSafitri.png);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-link"></span>
		    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="#">Yulianti Safitri</a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
			    						...
			    						<div class="two">
			    							<span class="price per-price">Rp 400.000<br><small>/Day</small></span>
		    							</div>
		    						</div>
		    						<p>Memudahkan Liburan Anda</p>
		    						<hr>
		    			...
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/person_4.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-link"></span>
		    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
			    						...
			    						<div class="two">
			    							<span class="price per-price">Rp 500.000<br><small>/Day</small></span>
		    							</div>
		    						</div>
		    						<p>Memudahkan Liburan Anda</p>
		    						<hr>
		    			...
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/suzy.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-link"></span>
		    						</div>
		    					</a>
		    				...
		    				<div class="destination">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
			    						...
			    						<div class="two">
			    							<span class="price per-price">Rp 550.000<br><small>/Day</small></span>
		    							</div>
		    						</div>
		    						<p>Memudahkan liburan anda</p>
		    						<hr>
          	...
          	<div class="row mt-5">
		          <div class="col text-center">
		            <div class="block-27">
		              <ul>
		                <li><a href="Tour Guide.php">&lt;</a></li> 
		                <li class="active"><a href="Tour Guide2.php">&gt;</a></li>
		              </ul>
		            </div>
		          </div>
		        </div>

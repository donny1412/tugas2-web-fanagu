            ...
            <div class="row">
              <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                <div class="destination">
                  <a href="hotel-tanijiwo.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotel/tani_jiwo/tanijiwo.jpg);">
                  ...
                  <div class="text p-3">
                    <div class="d-flex">
                      <div class="one">
                        <h3><a href="#">Tani Jiwo Hostel</a></h3>
                        <p class="rate">
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>
                    ...
                    <p class="bottom-area d-flex">
                      ...
                      <span class="ml-auto"><a href="hotel-tanijiwo.php">Book</a></span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                <div class="destination">
                  <a href="hotel-jiwajawa.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotel/jiwa_jawa/jiwajawa.jpg);">
                    <div class="icon d-flex justify-content-center align-items-center">
                      <span class="icon-link"></span>
                    </div>
                  </a>
              ...
              <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                <div class="destination">
                  <a href="MT-hotel.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/hotel/bromo_terrace/bromoterrace.jpg);">
                    <div class="icon d-flex justify-content-center align-items-center">
                      <span class="icon-link"></span>
                    </div>
                  </a>
                  <div class="text p-3">
                    <div class="d-flex">
                      <div class="one">
                        <h3><a href="MT-hotel.php">Bromo Terrace</a></h3>
                        <p class="rate">
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>
              ...
              <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                <div class="destination">
                  ...
                  <div class="text p-3">
                    <div class="d-flex">
                      <div class="one">
                        <h3><a href="MT-hotel.php">InterContinental Bandung Dago Pakar</a></h3>
                        <p class="rate">
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>
                          <i class="icon-star"></i>

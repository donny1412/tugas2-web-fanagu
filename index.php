      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 ftco-animate">
            <a href="yogyakarta.html" class="destination-entry img" style="background-image: url(images/visit1.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <a href="malang.html" class="destination-entry img" style="background-image: url(images/visit2.jpg);">
              <div class="text text-center">
                <h3>Malang</h3>
              </div>
            </a>
          ...
          <div class="col-md-4 ftco-animate">
            <a href="bali.html" class="destination-entry img" style="background-image: url(images/visit3.gif);">
              <div class="text text-center">
                <h3>Bali</h3>
              </div>
            </a>
    ...
    <section class="ftco-section">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="destination">
              <a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/destinasi1.jpg);">
                <div class="icon d-flex justify-content-center align-items-center">
                  <span class="icon-link"></span>
                </div>
              </a>

        ...
        <div class="row">
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="destination">
              <a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/jogja/prambanan.jpg);">
              ...
              <div class="text p-3">
                ...
                <p>Candi Prambanan merupakan candi Hindu terbesar di Indonesia. Candi ini memiliki relief yang menceritakan kisah mengenai Ramayana dan Krishnayana dan memiliki pemandangan yang indah.</p>
                <hr>
            ...
            <div class="destination">
              ...
              <div class="text p-3">
                <div class="d-flex">
                  ...
                  <div class="two">
                    <span class="price per-price">20.000<br><small>/orang</small></span>
                  </div>
                </div>
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="destination d-md-flex flex-column-reverse">
              <a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bandung/sukawana.jpg);">
                <div class="icon d-flex justify-content-center align-items-center">
                  <span class="icon-link"></span>
                </div>
              </a>
              <div class="text p-3">
                <div class="d-flex">
                  <div class="one">
                    <h3><a href="#">Kebun Teh Sukawana</a></h3>
                    <p class="rate">
                      <i class="icon-star"></i>
                      <i class="icon-star"></i>
                      <i class="icon-star"></i>
                ...
                <p>Tempat ini memang sedikit tersembunyi, namun cukup bagus. Kebun tehnya rapi dan hijau. Juga tidak bising. Tempatnya juga tidak begitu jauh dari Curug cimahi ataupun Dusun bambu.</p>
                <hr>
                <p class="bottom-area d-flex">
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="destination">
              <a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/jogja/nglambor.jpg);">
                <div class="icon d-flex justify-content-center align-items-center">
                  <span class="icon-link"></span>
                </div>
              </a>
              <div class="text p-3">
                <div class="d-flex">
                  <div class="one">
                    <h3><a href="#">Pantai Nglambor</a></h3>
                    <p class="rate">
                      <i class="icon-star"></i>
                      <i class="icon-star"></i>
                      <i class="icon-star"></i>
                ...
                <p>Di Pantai Nglambor terdapat laguna dengan air yang cukup tenang dan bisa menyebrang ke pulau kecil menggunakan jembatan tali, dan terdapat spot unik dan asyik untuk berfoto. Kekayaan alam disini bisa kita nikmati sambil snorkeling.</p>
                <hr>
                <p class="bottom-area d-flex">
                  <span><i class="icon-map-o"></i> Yogyakarta</span>
                  <span class="ml-auto"><a href="#">Open Now</a></span>

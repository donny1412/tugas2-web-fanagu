          ...
          <div class="col-md-12 tab-wrap"> 
            <div class="tab-content p-4 px-5" id="v-pills-tabContent"> 
              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                <form action="yogyakarta.html" class="search-destination">
                  <div class="row"> 
    ...
    <section class="ftco-section">
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="destination">
              ...
              <div class="text p-3">
                ...
                <p class="bottom-area d-flex">
                  <span><i class="icon-map-o"></i> Batu, Malang</span>
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="destination d-md-flex flex-column-reverse">
              ...
              <div class="text p-3">
                ...
                <hr>
                <p class="bottom-area d-flex">
                  <span><i class="icon-map-o"></i> Badung, Bali</span>
                  <span class="ml-auto"><a href="#">Open Now</a></span>
                </p>
              </div>
            </div>
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="destination">
              <a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bandung/lakeside.jpg);">
                <div class="icon d-flex justify-content-center align-items-center">
                  <span class="icon-link"></span>
                </div>
              </a>
              <div class="text p-3">
                ...
                <p>Tempat ini masih berada di dalam area Glamping Lakeside Rancabali. Obyek wisata yang terkenal, menarik, dan unik, dengan menyugguhkan icon kapal terdampar di pinggir danau.</p>
                <hr>
                <p class="bottom-area d-flex">

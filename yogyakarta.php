      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">YOGYAKARTA</h1>
          </div>
        </div>
      </div>
    </div>
	...
	<section class="ftco-section">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="destination d-md-flex flex-column-reverse">
              <a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/jogja/poktunggal.jpg);">
                <div class="icon d-flex justify-content-center align-items-center">
                  <span class="icon-link"></span>
                </div>
              </a>
              <div class="text p-3">
                ...
                <p>Pantai ini tidak kalah dengan pantai lainnya di Yogyakarta. Fasilitasnya memang belum selengkap tempat lain, tapi sepadan dengan pemandangan yang bisa anda dapatkan.</p>
                <hr>
                <p class="bottom-area d-flex">
                  <span><i class="icon-map-o"></i> Yogyakarta</span>
                  <span class="ml-auto"><a href="#">Open Now</a></span>
